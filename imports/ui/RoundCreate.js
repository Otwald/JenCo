    ...
    create = (
      <form className="was-validated">
        ...
        <div className="form-group row justify-content-center">
          <label className="col-sm-3 col-form-label">Runden Name</label>
          <div className="col-sm-9">
            <input
              ...
              placeholder={props.round_create.round_name}
            />
          </div>
        </div>
        <div className="form-group row justify-content-center">
          <label className="col-sm-3 col-form-label">Setting</label>
          <div className="col-sm-9">
            <input
              required
              value={setting}
              ...
              placeholder={props.round_create.setting}
            />
          </div>
        </div>
        <div className="form-group row justify-content-center">
          <label className="col-sm-3 col-form-label">Regelwerk</label>
          <div className="col-sm-9">
            <input
              required
              value={ruleset}
              ...
              placeholder={props.round_create.ruleset}
            />
          </div>
        </div>
        <div className="form-group row justify-content-center">
          ...
          <div className="col-sm-9">
            <input
              ...
              name="round_max_pl"
              className="form-control"
              onChange={(event) => setMax_pl(Number(event.target.value))}
              placeholder={props.round_create.round_max_pl}
            />
          </div>
        </div>
        <div className="form-group row justify-content-center">
          ...
          <div className="col-sm-9">
            <input
              ...
              max={max_pl}
              type="number"
              name="round_max_online_pl"
              className="form-control"
              onChange={(event) => setMax_online_pl(Number(event.target.value))}
              placeholder={props.round_create.round_max_online_pl}
            />
          </div>
        </div>
        <div className="form-group row justify-content-center">
        ...
        <div className="form-group row justify-content-center">
          <label className="col-sm-3 col-form-label">Rundenbeschreibung</label>
          <div className="col-sm-9">
            <ReactQuill
              required
              value={desc}

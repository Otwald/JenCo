                    ...
                    {change_pw ?
                        <React.Fragment>
                            <div className='row justify-content-center'>
                                <div className="card">
                                    <div className="card-body" onSubmit={() => { onPasswordChange() }}>
                                        <h5 className='card-title'>Altes Passwort</h5>
                                        <p className='text-muted'>
                                            <input required minLength='6' type='password' className='form-control' onChange={() => setOld_PW(event.target.value)} placeholder='Altes Passwort' autoComplete='off' />
                                        </p>
                                        <h5 className='card-title'>Neues Passwort</h5>
                                        <p className='text-muted'>
                                            <input required minLength='6' type='password' className='form-control' onChange={() => setNew_PW(event.target.value)} placeholder='Neues Passwort' autoComplete='off' />
                                        </p>
                                        <h5 className='card-title'>Passwort wiederholen</h5>
                                        <p className='text-muted'>
                                            <input required minLength='6' type='password' className='form-control' onChange={() => setCon_PW(event.target.value)} placeholder='Passwort wiederholen' autoComplete='off' />
                                        </p>
                                        <button className='btn btn-outline-dark' onClick={() => { setChange_PW(false); event.preventDefault() }} >Abbruch</button>
                                        <button className='btn btn-outline-dark' onClick={() => { event.preventDefault(); onPasswordChange() }} >Bestätigen</button>
                                        {announce}
                                    </div>
                                </div>
                            </div>
                        ...
                        <React.Fragment>
                            {edit ?
                                <form className='was-validated card-account'>
                                    ...
                                    <div className='form-row justify-content-center'>
                                        <div className='form-group col-sm-3'>
                                            <button className='btn btn-outline-dark' onClick={() => { setEdit(false); event.preventDefault() }} >Abbruch</button>
                                        </div>
                                        <div className='form-group col-sm-3'>
                                    ...
                                    <div className="card">
                                        <div className="card-body">
                                            {props.user ?
                                                ...
                                                : ''}
                                            <button className='btn btn-outline-dark' onClick={() => { setEdit(true); updateParams() }} >Ändern</button>
                                            <button className='btn btn-outline-dark' onClick={() => { setChange_PW(true) }} >Passwort ändern</button>
                                        </div>
                                    </div>
                                </div>
                            }

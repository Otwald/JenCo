        ...
        login = <li className="nav-item py-0">
            <div className={props.tab === 'account' ? `nav-link active` : "nav-link"}>
                <button className='button' onClick={() => props.onTabChange('account')}>
                    <i className='user_icon'></i><span className="d-none d-sm-block">Account</span>
                </button>
            </div>
        </li>
        if (admin) {
        ...
        <ul className="nav nav-fill nav-tabs justify-content-center nav-bar">
            <li className="nav-item py-0">
                <div className={props.tab === 'welcome' ? `nav-link active` : "nav-link"}>
                    <button className='button' onClick={() => props.onTabChange('welcome')} >
                        <i className='home_icon'></i><span className="d-none d-sm-block">Willkommen</span>
                    </button>
            ...
            <li className="nav-item py-0">
                <div className={props.tab === 'round' ? `nav-link active` : "nav-link"}>
                    <button className='button' onClick={() => props.onTabChange('round')} >
            ...
            {Meteor.userId() != null ?
                <li className="nav-item py-0">
                    <div className={props.tab === 'login' ? `nav-link active` : "nav-link"}>
                        <button className='button' onClick={() => { Meteor.logout(); props.onTabChange('welcome') }} >
                ...
                <li className="nav-item py-0">
                    <div className={props.tab === 'login' ? `nav-link active` : "nav-link"}>
                        <button className='button' onClick={() => props.onTabChange('login')} >
